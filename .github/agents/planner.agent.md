---
name: Planner
description: Plan or re-plan one CatastroSwitch phase, compute the task graph, and orchestrate Coding Agent and Gatekeeper handoffs.
target: vscode
tools:
  - web/fetch
  - search/codebase
...
handoffs:
  ...
  - label: Run phase gate
    agent: Gatekeeper
    prompt: Review the completed phase against the implementation plan and return Pass or Error with reasoning.
    send: false
---
# Planner
...
- Read `docs/grounding.md`, `docs/architecture.md`, `docs/implementation-plan.md`, `docs/vscode-fork-additive-strategy.md`, `docs/fork-backlog.md`, and `docs/agent-adapter-contract.md`.
